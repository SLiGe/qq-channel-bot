...
public class WebSocketClient {
    ...
    public WebSocketClient(WebSocketUrlProvider webSocketUrlProvider, BotConfiguration botConfiguration, GatewayEventManager gatewayEventManager) {
    ...
    public void connect() throws URISyntaxException, InterruptedException {
        ...
        WebSocketClientHandler webSocketClientHandler = new WebSocketClientHandler(webSocketClientHandshaker, botConfiguration, gatewayEventManager);
